...
;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype.initParameters = function() {
		...
		this._hasMarkersFilters = ( hasMarkersFilters != undefined && hasMarkersFilters == 1 && this._permalink == '' ) ? true : false;
	...
	if ( this._customDisplaying == 'replace' || this._customDisplayingMap == 'replace'  ) {
		...
		//if NorthWest and SouthPoint have been entere by administrator
...
/*						if ( this._clusterizeMarkers ) {
						...
						// Show the markers index ?
						if ( this._hasMarkersFilters ) {
							this.addMarkersFilters();
						}
	...
	Plugin.prototype.setBoundsNonGeographicalMap = function() {
		...
		if ( this._isAdmin != ''  && ( this._customDisplaying == 'replace' || this._customDisplayingMap == 'replace'  ) ) {
			var _this = this;
	...
	/**
	 * Add filters to Big Map
	 */
	Plugin.prototype.addMarkersFilters = function() {
