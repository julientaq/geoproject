...
<html <?php language_attributes(); ?>>
    ...
    var layerProvider = new L.TileLayer ('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {maxZoom:18,noWrap:false, attribution:'<a href="https://openstreetmap.org">OpenStreetMap</a>' });
    
    var id_map = jQuery('.gp-leaflet-cape').attr('id');

    var map = new L.Map (id_map, { zoomControl: false }).addLayer(layerProvider);
